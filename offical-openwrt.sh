...
sed -i "s/CONFIG_PLATFORM_I386_PC=y/CONFIG_PLATFORM_I386_PC=n/g" rtl8192-linux-driver/Makefile
sed -i "s/ONFIG_PLATFORM_ARM_AARCH64=n/ONFIG_PLATFORM_ARM_AARCH64=y/g" rtl8192-linux-driver/Makefile
popd
